...
{
    [TestClass]
    public class Putt_Livro_Sucesso : BaseBDDTestFixture
    {
        ...
        private LivroEdicaoModel model;
        ...
        public override void When()
        {
            ...
            using (var server = new TestServer(webHostBuilder))
            {
                ...
                using (var client = server.CreateClient())
                {
                    ...
                    post = client.PutAsync("/api/livro", postContentLivro).GetAwaiter().GetResult();
                    retorno = post.Content.ReadAsStringAsync().GetAwaiter().GetResult();
                }
            }
        }
        ...
        public void Quando_CadastroNovoLivro_ComDadosPreenchidosCorretamente_Entao_Sucesso()
        {
            ...
            Assert.AreEqual("Livro atualizado com sucesso!", retorno);
        }
    }
}
