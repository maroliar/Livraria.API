...
{
    [TestClass]
    public class Post_Login_Cenario2_BadRequest : BaseBDDTestFixture
    {
        ...
        public void Quando_EfetuoLoginUsuario_ComUsuarioOuSenhaInvalidos_Entao_Erro()
        {
            // Assert
            Assert.IsNotNull(post);
            Assert.AreEqual(HttpStatusCode.BadRequest, post.StatusCode);
            Assert.IsTrue(retorno.Contains("Acesso Negado. Usuário Inválido!"));
        }
    }
}
